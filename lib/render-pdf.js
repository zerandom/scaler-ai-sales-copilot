...
export async function renderPdf(assetData, strategy, leadProfile) {
  ...
  // Determine local executable path for macOS/Linux if developing locally, else use sparticuz
  const isLocal = process.env.NODE_ENV === "development" || !process.env.VERCEL;
  
  // Optionally provide a known chromium path for local mac.
  // On MacOS, it might be in /Applications/Google Chrome.app/Contents/MacOS/Google Chrome
