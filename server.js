...
async function generateLeadAsset({ leadProfile, transcript, insights, evidence, strategy }) {
  ...
  const prompt = [
    ...
    "slide1_title: Title for the 'Situation' slide (string)",
    "slide1_subtitle: Subtitle for the 'Situation' slide (string)",
    "situation_items: exactly 5 objects {icon_letter (1 char), title, description} describing where the lead stands today",
    "slide2_title: Title for the 'Goals' slide (string)",
    "slide2_subtitle: Subtitle for the 'Goals' slide (string)",
    ...
    "slide3_title: Title for the 'Questions' slide (string)",
    "slide3_subtitle: Subtitle for the 'Questions' slide (string)",
    ...
    "slide4_title: Title for the 'Why Scaler' slide (string)",
    "slide4_subtitle: Subtitle for the 'Why Scaler' slide (string)",
    ...
    return await materializeLeadAsset(
      {
        ...
        slide1Title: parsed.slide1_title || fallback.slide1Title,
        slide1Subtitle: parsed.slide1_subtitle || fallback.slide1Subtitle,
        slide2Title: parsed.slide2_title || fallback.slide2Title,
        slide2Subtitle: parsed.slide2_subtitle || fallback.slide2Subtitle,
        slide3Title: parsed.slide3_title || fallback.slide3Title,
        slide3Subtitle: parsed.slide3_subtitle || fallback.slide3Subtitle,
        slide4Title: parsed.slide4_title || fallback.slide4Title,
        slide4Subtitle: parsed.slide4_subtitle || fallback.slide4Subtitle,
...
function buildFallbackLeadAsset({ leadProfile, insights, evidence, strategy }) {
  ...
  if (strategy.key === "senior-operator") {
    return {
      ...
      slide1Title: "Is this worth your time?",
      slide1Subtitle: "A snapshot of your current situation",
      slide2Title: "Your transition path",
      slide2Subtitle: "What you want to achieve next",
      slide3Title: "Your Key Questions, Answered",
      slide3Subtitle: "Honest answers to what matters most to you",
      slide4Title: "Why Scaler",
      slide4Subtitle: "Designed for engineers. Built for outcomes.",
      situationItems: [
  ...
  if (strategy.key === "career-risk") {
    return {
      ...
      slide1Title: "Your situation right now",
      slide1Subtitle: "A snapshot of your current situation",
      slide2Title: "Your Goals",
      slide2Subtitle: "What you want to achieve next",
      slide3Title: "Key Questions & Concerns",
      slide3Subtitle: "Honest answers to what matters most to you",
      slide4Title: "What Scaler Offers",
      slide4Subtitle: "Designed for engineers. Built for outcomes.",
      situationItems: [
  ...
  return {
    ...
    slide1Title: "Where You Stand Today",
    slide1Subtitle: "A snapshot of your current situation",
    slide2Title: "Your Goals",
    slide2Subtitle: "What you want to achieve next",
    slide3Title: "Your Key Questions, Answered",
    slide3Subtitle: "Honest answers to what matters most to you",
    slide4Title: "Why Scaler is the Right Fit",
    slide4Subtitle: "Designed for engineers. Built for outcomes.",
    situationItems: [
